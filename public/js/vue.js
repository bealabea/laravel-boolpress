  ...
  methods: {
    getUser: function getUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/user').then(function (resp) {
        ...
        _this.user = resp.data; // salvo l'utente in localStorage con stringify che prende un oggetto e lo converte in JSON

        localStorage.setItem("user", JSON.stringify(resp.data)); // evento custom
...
var render = function () {
  ...
  return _c("div", { staticClass: "container mt-5 text-center" }, [
    _vm.user
      ? _c("h6", [_vm._v("Made with ♥ by " + _vm._s(_vm.user.name) + "\n    ")])
      : _vm._e(),
  ])
}
var staticRenderFns = []
...
var render = function () {
  ...
  return _c("div", [
    _c(
      "nav",
      { staticClass: "navbar navbar-dark bg-dark navbar-expand-md shadow" },
      [
                  ...
                  _c("li", { staticClass: "nav-item" }, [
                    !_vm.user
                      ...
                      : _c(
                          ...
                          [
                            _c("i", {
                              staticClass: "user_icon fas fa-user-ninja",
                            }),
                            _vm._v(" "),
...
var render = function () {
  ...
  return _c("div", { staticClass: "col-12 col-lg-4" }, [
    _c("div", { staticClass: "card post-card m-2 text_card" }, [
      _c("div", { staticClass: "card-body bg-dark rounded" }, [
        _c("img", {
          staticClass: "img-fluid rounded",
          attrs: { src: _vm.post.image, alt: "" },
        }),
        _vm._v(" "),
        _c("h5", { staticClass: "card-title mt-4" }, [
        ...
        _c("em", [
          ...
          _vm._v(
            "\n                  Data: " +
              _vm._s(_vm.dateFormat(_vm.post.created_at))
          ),
        ]),
        _c("br"),
        _vm._v(" "),
        _vm.post.category
          ? _c("strong", [_vm._v(_vm._s(_vm.post.category.genre))])
          : _vm._e(),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "mt-3 pt-3 border-top border-secondary" },
          [
            _c(
              "router-link",
              {
              ...
              [
                _vm._v("\n                      Details"),
                _c("i", { staticClass: "fas fa-chevron-right ms-2" }),
              ]
            ),
          ],
          1
...
var render = function () {
  ...
  return _c("div", [
    ...
    !_vm.formSubmitted
      ...
      : _c("div", [_c("h2", [_vm._v("Grazie per averci contattato")])]),
  ])
}
var staticRenderFns = []
render._withStripped = true
...
var render = function () {
  ...
  return _c("div", { staticClass: "container m-4" }, [
    _c("h1", { staticClass: "dark" }, [_vm._v(_vm._s(_vm.post.title))]),
    _vm._v(" "),
    _c("img", {
    ...
    _vm._v(" "),
    _c("p", {
      staticClass: "card-text bg-light mt-4",
...
module.exports = __webpack_require__(/*! C:\Users\total\Desktop\BOOLEAN\php\laravel-boolpress\resources\js\vue.js */"./resources/js/vue.js");
